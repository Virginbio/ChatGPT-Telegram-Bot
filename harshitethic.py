...
if aienv == None:
    openai.api_key = "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"
else:
    openai.api_key = aienv
print(aienv)

#Telegram bot key
tgenv = os.getenv('6052742409:AAFiNlwfRL-qQyLgTPB3lqKYTPrAOVynhys')
if tgenv == None:
    tgkey = "Kibbles.assitant"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'Kibbles.assitant'
username = 'Kibbleinubot'
